...
STATIC_URL = '/static/'    # substitua nome_aplicacao pelo nome da sua aplicação
...
CLOUDINARY_STORAGE = {
  'CLOUD_NAME': "drj6qgln4",
  'API_KEY': "432817184815217",
  'API_SECRET': "gt5hYJeHvm0ovysLtEwwCOC7whA",
}
